...
function sessionCheck(request, response, next) {
    //next();  //solo para TEST (probar operativas sin que nos obligue a tener sesion) 
...
//router.get('/promotores', sessionCheck, function(request, response) {
...
//router.post('/promotores/add', function(request, response) {  //Sin validar sesión de usuario para probar fácil
	...
	Promotor.findOne({ 'codigop' :  codpromo }, function(err, promotor) {
		...
		if (err){
            //console.log("Error al intentar crear un nuevo promotor con codigo: " + codpromo);
            //console.log(err);
		...
		if (promotor) {
            //console.log("Ese código de promotor ya existe en el sistema");
            //console.log(err);
